  ...
  public: {
    Tables: {
      ...
      electrical_schemas: {
        ...
        Relationships: [
          {
            foreignKeyName: "electrical_schemas_project_id_fkey"
            columns: ["project_id"]
            isOneToOne: true
            referencedRelation: "projects"
            referencedColumns: ["id"]
      ...
      projects: {
        Row: {
          ...
          charge_attelage_s_kg: number | null
          ...
          mmta_essieu_ar_kg: number | null
          mmta_essieu_av_kg: number | null
          mmta_kg: number | null
          modele: string | null
          ...
          offset_zone_chargement_mm: number | null
          pesee_essieu_ar_kg: number | null
          pesee_essieu_av_kg: number | null
          photo_url: string | null
          places_assises_origine: number | null
          poids_vide_kg: number | null
          porte_a_faux_arriere_mm: number | null
          porte_a_faux_avant_mm: number | null
          porte_faux_arriere_mm: number | null
          porte_faux_avant_mm: number | null
          prenom_proprietaire: string | null
          ptac_kg: number | null
          ptra: number | null
          puissance_fiscale: number | null
          puissance_kw: number | null
          reservoir_adblue_distance_av_mm: number | null
          reservoir_adblue_litres: number | null
          reservoir_adblue_taux_remplissage: number | null
          reservoir_carburant_distance_av_mm: number | null
          reservoir_carburant_litres: number | null
          reservoir_carburant_taux_remplissage: number | null
          reservoir_gpl_distance_av_mm: number | null
          reservoir_gpl_litres: number | null
          reservoir_gpl_taux_remplissage: number | null
          ...
          user_id: string | null
          vasp_coffres: Json | null
          vasp_rangees_sieges: Json | null
          vasp_reservoir_gaz: Json | null
          vasp_reservoirs_eau: Json | null
