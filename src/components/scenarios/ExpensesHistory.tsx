    ...
    <Dialog open={true} onOpenChange={onClose}>
      <DialogContent className="max-w-[800px] h-[80vh] flex flex-col">
                      ...
                      <div className="flex-1 space-y-2">
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm text-muted-foreground">{formatDate(entry.date_modification)}</span>
                          </div>
                        </div>

                        {/* Article */}
                        <div>
                          <p className="font-semibold">{oldData.nom_accessoire || "Article inconnu"}</p>
                          {oldData.marque && <p className="text-sm text-muted-foreground">{oldData.marque}</p>}
                        </div>
                        ...
                        <div className="text-sm space-y-1">
                          ...
                          {entry.action === "modification" && (
                            <div className="text-muted-foreground">Article modifié</div>
                          )}
        ...
        <div className="flex justify-between items-center pt-4 border-t">
          <div className="text-sm text-muted-foreground">{history.length} modification(s) enregistrée(s)</div>
