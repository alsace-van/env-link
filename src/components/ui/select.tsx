...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex min-h-10 w-full items-center justify-between rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-3",
      className,
    )}
    {...props}
  >
...
>(({ className, children, ...props }, ref) => (
  ...
  >
    ...
    <SelectPrimitive.ItemText className="whitespace-normal break-words w-full">{children}</SelectPrimitive.ItemText>
  </SelectPrimitive.Item>
));
