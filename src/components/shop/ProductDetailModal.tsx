...
export const ProductDetailModal = ({ productId, onClose, onConfigure }: ProductDetailModalProps) => {
  ...
  const loadProduct = async () => {
    ...
    if (productData) {
      ...
      // Load product items for bundles and kits
  ...
  const handleAddToCart = () => {
    ...
    if (product.product_type === "custom_kit" && onConfigure) {
      ...
      addToCart(product.id, 1, null, product.prix_base);
      onClose();
    }
  };
                          ...
                          {accessories.map((item: any) => (
                            ...
                            >
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                {item.accessory?.prix_vente_ttc && (
                                  <p className="text-sm font-medium mt-1">
                                    {item.accessory.prix_vente_ttc.toFixed(2)} €
                                  </p>
                                )}
                              </div>
                            </div>
                    ...
                    <>
                      ...
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground mt-2">
                          Notice technique disponible prochainement
                        </p>
                      </div>
                    </>
                  )}
