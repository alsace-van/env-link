    ...
    onChange(
      value.map((section) =>
        section.id === sectionId
          ? { ...section, category_id: categoryId, selected_accessory_ids: [] }
          : section
      )
    );
  };
                        ...
                        <div className="space-y-2">
                          <div className="flex items-center justify-between">
                            <Label className="text-xs">
                              Articles disponibles ({section.selected_accessory_ids.length} sélectionné{section.selected_accessory_ids.length > 1 ? "s" : ""})
                            </Label>
