...
// - Grille 4 colonnes avec miniatures plus grandes (h-40)
// - Zone de scroll augmentée (500px) pour comparer les doublons
//
...
export function ArucoStitcher({ isOpen, onClose, onStitched, markerSizeMm = 100 }: ArucoStitcherProps) {
  ...
  // v3.5: Modale agrandie pour mieux voir les miniatures
  return (
        ...
        <div className="space-y-4">
          ...
          {photos.length > 0 && (
            <div className="space-y-2">
              ...
              {/* v3.5: Grille agrandie - 4 colonnes, hauteur max 500px */}
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 max-h-[500px] overflow-y-auto p-1">
                {photos.map((photo, idx) => {
                  ...
                  return (
                    ...
                    >
                      {/* v3.5: Miniatures plus grandes */}
                      <img
                        src={photo.imageUrl}
                        alt={`Photo ${idx + 1}`}
                        className="w-full h-40 object-contain rounded bg-gray-200"
                      />
