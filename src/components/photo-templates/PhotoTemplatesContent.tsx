...
import { PhotoTemplateCard } from "./PhotoTemplateCard";
import { PhotoTemplateCreationWizard } from "./PhotoTemplateCreationWizard";
import type { PhotoTemplate } from "@/types/photo-templates";

interface PhotoTemplatesContentProps {
  projectId: string;
}

export function PhotoTemplatesContent({ projectId }: PhotoTemplatesContentProps) {
