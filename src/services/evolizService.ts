...
class EvolizApiService {
  ...
  async createArticle(article: {
    ...
    if (article.purchase_unit_price_vat_exclude) {
      body.purchase_unit_price_vat_exclude = article.purchase_unit_price_vat_exclude;
    }

    // Ajouter le fournisseur si disponible
    if (article.supplierid) {
      body.supplierid = article.supplierid;
    }
