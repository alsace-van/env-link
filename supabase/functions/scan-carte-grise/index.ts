REMPLACEMENT COMPLET du fichier scan-carte-grise

Je vais te donner le code COMPLET du fichier 
supabase/functions/scan-carte-grise/index.ts

INSTRUCTIONS CRITIQUES :
1. SUPPRIME complètement l'ancien fichier
2. CRÉE un nouveau fichier avec ce code EXACT
3. Ne modifie RIEN au code que je te donne
4. Après remplacement, REDÉPLOIE IMMÉDIATEMENT la fonction
...
EXEMPLE DE RÉPONSE ATTENDUE :
{
  ...
  "confidence": 92
    ...
    // CORRECTION CRITIQUE : gemini-2.0-flash-exp (pas gemini-1.5-flash)
...
IMPORTANT : Après avoir remplacé le fichier, REDÉPLOIE immédiatement :
"Deploy the edge function scan-carte-grise"